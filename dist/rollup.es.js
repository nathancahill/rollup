/*
	Rollup.js v0.41.4
	Mon Jan 30 2017 14:03:08 GMT-0500 (EST) - commit 881bc19f7e372f18cf0c520bf7e5bae157febe38
...
var ANNOTATION_RE = /^\s?rollup-tree-shake\s+([a-z-]+)/;
...
var Module = function Module (ref) {
	...
	this.annotations = this.comments.filter(function (comment) {
		var match = ANNOTATION_RE.exec(comment.text);
